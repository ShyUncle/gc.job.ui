  ...
  <el-row class="panel-group"
    ...
    <el-col :xs="12"
      ...
      <div class="card-panel"
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">本日调度次数</div>
          <count-to class="card-panel-num"
                    :startVal="0"
                    :endVal="summary.triggerCount"
    ...
    <el-col :xs="12"
      ...
      <div class="card-panel"
        ...
        <div class="card-panel-description">
          <div class="card-panel-text">本日成功执行次数</div>
          <count-to class="card-panel-num"
                    :startVal="0"
                    :endVal="summary.successCount"
...
import { fetchSummary } from '@/api/index'
export default {
  components: {
    CountTo
  },
