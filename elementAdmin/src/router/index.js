...
export const asyncRouterMap = [
  {
    ...
    children: [{
      path: 'list', component: () => import('@/views/jobExecutor/list'),
      name: '执行器列表',
      meta: { title: '执行器列表' }
    }]
  },
  {
    ...
    children: [{
      path: 'list', component: () => import('@/views/jobinfo/list'),
      name: '任务调度中心',
      meta: { title: '任务调度中心' }
    },
    {
      path: 'jobLog/:id(\\d+)', component: () => import('@/views/jobLog/list'),
      name: '日志',
      meta: { title: '日志' },
      hidden: true
    }]
